...
import kotlinx.android.synthetic.main.fragment_list_classics.*
import java.util.*

abstract class ClassicLisFragment<M, VH : RecyclerView.ViewHolder, A : RecyclerView.Adapter<VH>> :
    CoroutineFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_list_classics, container, false)
    }
     ...
     *
     * */
    protected abstract fun onNextPage(
        page: Int,
        onResult: () -> Unit,
        onLoad: (list: List<M>) -> Unit
    )
