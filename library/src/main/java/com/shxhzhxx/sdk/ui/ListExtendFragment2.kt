...
import kotlinx.android.synthetic.main.fragment_extend_list3.*
import java.util.*

abstract class ListExtendFragment2<M, VH : RecyclerView.ViewHolder, A : RecyclerView.Adapter<VH>> : CoroutineFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_extend_list3, container, false)
    }
